...
export const zh_TW = {
  ...
  wizard: {
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) 執行：./occ talk:bot:install "EzClaw Agent" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    signal: {
      ...
      multipleEntries: "多個項目請用逗號分隔。",
      nextLinkDevice: '綁定裝置：signal-cli link -n "EzClaw Agent"',
